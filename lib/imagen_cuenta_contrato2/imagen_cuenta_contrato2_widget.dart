...
import 'imagen_cuenta_contrato2_model.dart';
export 'imagen_cuenta_contrato2_model.dart';

class ImagenCuentaContrato2Widget extends StatefulWidget {
  const ImagenCuentaContrato2Widget({Key? key}) : super(key: key);

  @override
  _ImagenCuentaContrato2WidgetState createState() =>
      _ImagenCuentaContrato2WidgetState();
}

class _ImagenCuentaContrato2WidgetState
    extends State<ImagenCuentaContrato2Widget> {
  late ImagenCuentaContrato2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImagenCuentaContrato2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> imagenCuentaContrato2UsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final imagenCuentaContrato2UsersRecord =
            imagenCuentaContrato2UsersRecordList.isNotEmpty
                ? imagenCuentaContrato2UsersRecordList.first
                : null;
