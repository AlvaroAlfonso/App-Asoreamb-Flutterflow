...
import 'schema/recicladores_record.dart';
...
export 'schema/recicladores_record.dart';
...
/// Functions to query RecicladoresRecords (as a Stream and as a Future).
Future<int> queryRecicladoresRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RecicladoresRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RecicladoresRecord>> queryRecicladoresRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<RecicladoresRecord>> queryRecicladoresRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<RecicladoresRecord>> queryRecicladoresRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
Future<FFFirestorePage<TiendasRecord>> queryTiendasRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
